...
const SUCCESS_IMAGE = "/success.gif";
      ...
      <AnimatePresence mode="wait">
        ...
        {stage === "success" && (
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            className="z-10 text-center p-4 max-w-2xl mx-auto relative w-full"
          >
            {/* Back Button */}
            <motion.button
              ...
              className="absolute top-4 left-4 flex items-center gap-2 px-3 py-2 bg-white/90 hover:bg-white text-primary rounded-full shadow-md hover:shadow-lg transition-all duration-200 text-sm font-medium z-20"
            >
              <ArrowLeft className="w-4 h-4" />
              <span>Redo Puzzle</span>
            </motion.button>
            ...
            <motion.div
              ...
              animate={{
                boxShadow: [
                  "0px 10px 30px rgba(255, 105, 180, 0.3)",
                  "0px 10px 50px rgba(255, 105, 180, 0.6)",
                  "0px 10px 30px rgba(255, 105, 180, 0.3)",
                ],
              }}
